    ...
    return (
        <div className="row">
            ...
            <div className="d-flex justify-content-between">
                {
                    pokemones.length === 0 && 
                    <button onClick={() => dispatch(obtenerPokemonesAccion())} className="btn btn-primary">Get Pokemones</button>
                }
                {
                    next &&
                    <button onClick={() => dispatch(siguientePokemonAccion())} className="btn btn-primary">Siguiente</button>
                }
                {
                    previous &&
            ...
            <ul className="list-group mt-3">
                {
                    pokemones.map(item => (
                        <li key={item.name} className="list-group-item text-uppercase">
                            {item.name}
                            <button onClick={() => dispatch(unPokeDetalleAccion(item.url))} className="btn btn-warning btn-sm float-end">Info</button>
                            </li>
                    ))
                }
            </ul>
